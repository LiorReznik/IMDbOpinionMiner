...
class Trainer:
    ...
    def train(self):
        max_features = 25000
        batch_size = 32
        tensorboard = TensorBoard(log_dir='./logs/FINAL3', histogram_freq=0,write_graph=True, write_images=False)
#tensorboard --logdir=C:\sentimentReviews-master\logs\ --host=localhost --port=80
        ...
        checkpiont=ModelCheckpoint('Checkpoints/FINAL3.h5', monitor='val_loss', verbose=1, save_best_only=True,
